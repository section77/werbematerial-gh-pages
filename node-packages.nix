...
let
  sources = {
    ...
    "node-releases-1.1.49" = {
      ...
      version = "1.1.49";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-releases/-/node-releases-1.1.49.tgz";
        sha512 = "xH8t0LS0disN0mtRCh+eByxFPie+msJUBL/lJDBuap53QGiYPa9joh83K4pCZgWJ+2L4b9h88vCVdXQ60NO2bg==";
      };
    };
    "normalize-url-3.3.0" = {
      name = "normalize-url";
  ...
  args = {
    ...
    packageName = "werbematerial-gh-pages";
    version = "0.0.0";
    src = ./.;
    dependencies = [
    ...
    meta = {
      description = "* Web Gallerie für unser Werbematerial";
      homepage = "https://github.com/section77/werbematerial-gh-pages#readme";
      license = "ISC";
    };
    production = true;
    bypassCache = true;
